...
wc -l authfd.c authfile.c bufaux.c bufbn.c bufec.c buffer.c \
	...
	platform-pledge.c platform-tracing.c ssh_api.c \
	ssherr.c \
	sshbuf.c \
	sshkey.c \
	...
	krl.c \
	bitmap.c \
        ssh.c readconf.c clientloop.c sshtty.c sshconnect.c \
        sshconnect1.c sshconnect2.c mux.c
