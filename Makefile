...
CC=gcc
LD=gcc
CFLAGS=-g -O0 -Wall -Wpointer-arith -Wuninitialized -Wsign-compare -Wformat-security -Wsizeof-pointer-memaccess -Wno-pointer-sign -Wno-unused-result -fno-strict-aliasing -D_FORTIFY_SOURCE=2 -ftrapv -fno-builtin-memset -fstack-protector-all -fPIE -ftest-coverage -fprofile-arcs
CPPFLAGS=-I. -I$(srcdir)  $(PATHS) -DHAVE_CONFIG_H
LIBS=-lresolv -lcrypto -ldl -lutil -lz  -lcrypt -lgcov
K5LIBS=
GSSLIBS=
SSHLIBS=
SSHDLIBS=
...
LDFLAGS=-L. -Lopenbsd-compat/  -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -fstack-protector-all -pie -ftest-coverage -fprofile-arcs
EXEEXT=
